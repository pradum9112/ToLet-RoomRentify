        ...
        <div className="infoTab">
          ...
          >
            ...
            <div className="card-body" style={{ padding: "4px 8px 8px 8px" }}>
              <h3 className="card-title text-truncate" style={{ fontSize: "16px", fontWeight: "bold", margin: "0 0 4px 0" }}>
                {tooltip}
              </h3>
              <hr style={{ margin: "4px 0" }} />
              
              <p className="card-text" style={{ margin: "3px 0", fontSize: "12px" }}>
                Type: {placetype}
              </p>

              {/* Per Night Price with 10% Discount */}
              <div className="card-text d-flex align-items-center gap-1" style={{ margin: "3px 0px 2px 0px", fontSize: "12px" }}>
                <span>Price:</span>
                <span style={{ fontSize: "14px", fontWeight: "bold", color: "#2e7d32" }}>
                  ₹{discountedPrice}
                </span>
                <span className="text-danger" style={{ textDecoration: "line-through", fontSize: "11px" }}>
                  ₹{basePrice}
                </span>
                <span>/night</span>
              </div>
              ...
              {isbooked ? (
                <button
                  ...
                  style={{ background: "#534173", borderColor: "#534173", fontSize: "11px" }}
                >
                  Already Booked!
                </button>
              ) : (
                <Link to={`/detail/${text}`}>
                  <button className="btn btn-primary btn-sm w-100" style={{ fontSize: "11px" }}>
                    View Details
                  </button>
                </Link>
              )}
